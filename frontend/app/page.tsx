...
const LogoIcon = ({ size = 32 }: { size?: number }) => (
  <div style={{ width: size, height: size, borderRadius: size * 0.25, background: "linear-gradient(135deg,#00d9ff,#7c6ff7)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
...
function Nav() {
  const router = useRouter(); // ✅ hoisted into component
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-12 py-5 border-b"
      ...
      <div className="flex items-center gap-4">
        <button className="text-sm font-medium px-4 py-2 rounded-lg transition-all"
          style={{ background: "none", border: "none", cursor: "pointer", color: "var(--muted2)", fontFamily: "Outfit,sans-serif" }}
        ...
        <button className="text-sm font-medium px-5 py-2 rounded-lg transition-all"
          style={{ background: "var(--cyan)", color: "var(--bg)", border: "none", cursor: "pointer", fontFamily: "Outfit,sans-serif" }}
...
function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-32 pb-16 overflow-hidden z-10">
      ...
      <div className="fu3 flex items-center gap-4 mt-10 flex-wrap justify-center">
        <button
          className="inline-flex items-center gap-2 transition-all"
          style={{ fontFamily: "Outfit,sans-serif", fontSize: 15, fontWeight: 500, color: "var(--bg)", background: "var(--cyan)", padding: "0.85rem 2rem", borderRadius: 10, border: "none", cursor: "pointer" }}
        ...
        <button
          ...
          style={{ fontFamily: "Outfit,sans-serif", fontSize: 15, fontWeight: 500, color: "var(--text)", background: "none", border: "1px solid var(--border2)", padding: "0.85rem 2rem", borderRadius: 10, cursor: "pointer" }}
