    ...
    <main className="page-shell flex min-h-screen items-center justify-center px-6 py-10">
      <section className="panel w-full max-w-md p-7 sm:p-8">
        <div className="mb-6 flex items-center justify-between border-b border-white/10 pb-4">
          <p className="mono text-xs uppercase tracking-[0.14em] text-white/60">Authentication</p>
          <button
            onClick={() => router.push("/")}
        ...
        <h1 className="text-2xl font-medium text-white">{isLogin ? "Sign in" : "Create account"}</h1>
        ...
        <button
          ...
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg border border-white/15 bg-white/[0.02] px-4 py-2.5 text-sm text-white transition hover:border-white/25 hover:bg-white/[0.04]"
        >
          <GoogleIcon />
        ...
        <div className="my-5 flex items-center gap-3">
          ...
          <span className="mono text-[10px] uppercase tracking-[0.12em] text-white/45">or</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>
        ...
        {error && (
          <p className="mt-3 rounded-lg border border-red-400/30 bg-red-500/10 px-3 py-2 text-xs text-red-300">{error}</p>
        )}

        <button
          className="mt-5 w-full rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-black transition hover:opacity-90 disabled:opacity-50"
